    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('key_points', models.TextField(blank=True, help_text='Enter key learning points separated by semicolon (;)')),
                ('category', models.CharField(choices=[('programming', 'Programming'), ('math', 'Mathematics'), ('science', 'Science'), ('business', 'Business'), ('other', 'Other')], default='other', max_length=50)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('learnings', django_ckeditor_5.fields.CKEditor5Field()),
                ('video_url', models.URLField(blank=True, null=True)),
                ('order', models.PositiveIntegerField(default=0)),
                ('duration', models.DurationField(blank=True, default=datetime.timedelta(0), null=True)),
                ('thumbnail_image', models.ImageField(blank=True, null=True, upload_to='lesson_thumbnails/')),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
        ...
        migrations.CreateModel(
            ...
            options={
                'constraints': [models.UniqueConstraint(fields=('user', 'quiz'), name='unique_user_quiz_attempt')],
            },
        ),
    ]
