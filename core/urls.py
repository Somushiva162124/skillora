...
urlpatterns = [
    ...
    # Quizzes
    path('quizzes/list/', views.quiz_list, name='quiz_list'),
    path('course/<int:course_id>/lesson/<int:lesson_id>/quiz/', views.quiz_view, name='quiz_page'),  # ✅ Only keep one
    path('quiz/<int:quiz_id>/', views.quiz_display, name='quiz_display'),  # ✅ different route — keep it
